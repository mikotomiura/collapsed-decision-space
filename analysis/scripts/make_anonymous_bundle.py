...
def main(argv: list[str] | None = None) -> int:
    ...
    (out / "ANONYMISED.md").write_text(
        ...
        "bundle. The last step compares the sealed files against the checksums an archive "
        "publishes for its own copy of them; it reads a recorded answer rather than the "
        "network, so it runs here too, and while no such record exists it skips itself and "
        "says so.\n\n"
