...
| G20 | The Pearson surrogate is the power of the design or of its decision test; the design was adequately powered | `power` is the **nominal sensitivity of a surrogate**. The sealed design did not evaluate the power of the permutation test. The post hoc simulation of §5.1.3 reports its simulated rejection rate under declared, assumed bases; that is not the design being adequately powered, and both statements must stay sayable | `(design\|study\|protocol\|experiment) (was\|is) (adequately \|well \|sufficiently \|fully \|highly )?powered`, `power of the (stratified )?(label-)?permutation test (is\|was) (1\|0\.\d\|high\|full\|adequate\|sufficient\|above)`, `(design\|study) (had\|has\|achieved) (full \|adequate \|sufficient \|enough )?power`, `(design\|study\|protocol\|experiment) (had\|has) (enough\|adequate\|sufficient) sensitivity to detect` |
