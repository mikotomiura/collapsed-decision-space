...
| [42] | Minimax estimation of the L1 distance between discrete distributions; in its large-alphabet, non-asymptotic setting the plug-in estimate is not rate-optimal. Supports the statement that estimating the distance is a problem in its own right. **No efficiency claim is made for `tv_bar`** | §1.3, §2 |
